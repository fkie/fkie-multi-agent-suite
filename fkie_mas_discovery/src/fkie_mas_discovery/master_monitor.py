...
class MasterMonitor:
    ...
    :see: :mod:`fkie_mas_discovery.master_monitor.MasterMonitor.getCurrentState()`, respectively
          :mod:`fkie_mas_discovery.master_monitor.MasterMonitor.updateState()`
    ...
    def __init__(self, rpc_port=1161, do_retry=True, ipv6=False, rpc_addr='', connect_server=False, ws_port=ws_port()):
        ...
        if connect_server:
            Log.info(f"connect to web socket http://localhost:{self.ws_port}")
...
#          print "_getNodePid _lock RET", threading.current_thread()
    ...
    def updateState(self, clear_cache=False):
        ...
        :param clear_cache: The URI of nodes and services will be cached to reduce the load.
                            ...
                            :mod:`fkie_mas_discovery.master_monitor.MasterMonitor.MAX_PING_SEC`.
