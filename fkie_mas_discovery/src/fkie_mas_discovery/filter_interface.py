...
from .common import create_pattern, gen_pattern, get_ros_param, is_empty_pattern, read_interface, resolve_url
...
class FilterInterface:
    ...
    :mod:`fkie_mas_discovery.filter_interface.FilterInterface.load()` or
    :mod:`fkie_mas_discovery.filter_interface.FilterInterface.from_list()`.
    ...
    def load(
        ...
        """
        Reads the parameter and creates the pattern using :mod:`fkie_mas_discovery.common.create_pattern()`
        """
        ...
        self._re_ignore_publishers = create_pattern(
            "ignore_publishers", data, interface_file, ignore_publishers, mastername
        )
        self._re_ignore_subscribers = create_pattern(
            "ignore_subscribers", data, interface_file, ignore_subscribers, mastername
        )
    ...
    def set_hide_pattern(
        self, re_hide_nodes=EMPTY_PATTERN, re_hide_topics=EMPTY_PATTERN, re_hide_services=EMPTY_PATTERN
    ):
    ...
    def is_ignored_topic(self, node, topic, topictype):
        ...
        """
        Log.warn(
            "Call to deprecated method 'is_ignored_topic'",
