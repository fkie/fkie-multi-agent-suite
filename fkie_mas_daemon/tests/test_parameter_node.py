...
class TestParameter(Node):
    def __init__(self):
        ...
        integer_descriptor = ParameterDescriptor(
            description="This is a test parameter with integer range",
            integer_range=[IntegerRange(from_value=-2, to_value=30, step=2)],
        )
        double_descriptor = ParameterDescriptor(
            description="This is a test parameter with double range",
            floating_point_range=[FloatingPointRange(from_value=-1.5, to_value=25.5, step=0.5)],
        )
        double_wo_step_descriptor = ParameterDescriptor(
            description="This is a test parameter with double range, w/o step and no.step namespace",
            floating_point_range=[FloatingPointRange(from_value=-1.5, to_value=25.5)],
        )
