...
from fkie_mas_msgs.msg import SyncTopicInfo, SyncServiceInfo, SyncMasterInfo
import rospy
...
class SyncThread(object):
    ...
    def __init__(self, name, uri, discoverer_name, monitoruri, timestamp, sync_on_demand=False, callback_resync=None):
        ...
        self._filter.load(self.name,
                          ['/rosout', self.discoverer_name, '/mas_discovery', '/mas_sync', '/mas_daemon', '/mas_eroconf',
                              '/master_discovery', '/master_sync',
                              '/node_manager', '/node_manager_daemon', '/zeroconf', '/param_sync'], [],
                          ['/rosout', '/rosout_agg', '/mas_discovery/*', '/mas_sync/*', '/mas_daemon/*', '/mas_zeroconf/*',
                              '/master_discovery/*', '/master_sync/*', '/zeroconf/*'], ['/'] if sync_on_demand else [],
                          ['/*get_loggers', '/*set_logger_level', '/mas_discovery/*', '/mas_sync/*', '/mas_daemon/*', '/mas_zeroconf/*',
                              '/master_discovery/*', '/master_sync/*', '/node_manager_daemon/*', '/zeroconf/*'], [],
                          # do not sync the bond message of the nodelets!!
                          ['bond/Status', 'fkie_mas_msgs/SyncTopicInfo', 'fkie_mas_msgs/SyncServiceInfo',
                              'fkie_mas_msgs/SyncMasterInfo', 'fkie_mas_msgs/MasterState'],
                          [], [],
                          [])
