...
ros2 run fkie_mas_daemon mas-remote-node.py  --name=/mas/_discovery_{HOST} --set_name=false --node_type=mas-discovery --package=fkie_mas_discovery
...
ELECTRON_ENABLE_LOGGING=1 mas-gui --no-sandbox
