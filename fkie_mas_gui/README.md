...
| ros.nodes.get_list                 | RPC  | `() => List[RosNode]`                                                     | see fkie_mas_pylib/crossbar/runtime_interface/RosNode                                    |
...
| ros.provider.warnings              | PUB  | `=> [SystemWarningGroup]`                                                 | see fkie_mas_pylib/crossbar/runtime_interface/SystemWarningGroup                         |
| ros.packages.get_list              | RPC  | `(clear_cache: bool) => List[RosPackage]`                                 | see fkie_mas_pylib/crossbar/file_interface/RosPackage                                    |
| ros.path.get_list                  | RPC  | `(inputPath: str) => List[PathItem]`                                      | see fkie_mas_pylib/crossbar/file_interface/PathItem                                      |
| ros.path.get_list_recursive        | RPC  | `(inputPath: str) => List[PathItem]`                                      | Return all files/folders included in input path                                          |
| ros.path.get_log_paths             | RPC  | `(nodes: List[str]) => List[RosPackage]`                                  |                                                                                          |
| ros.path.clear_log_paths           | RPC  | `(nodes: List[str]) => List[{node: str, result: bool, message: str}]`     | Removes log files (ROS and screen) for given nodes                                       |
...
| ros.launch.load                    | RPC  | `(request: LaunchLoadRequest) => LaunchLoadReply`                         | Loads launch file by crossbar request                                                    |
| ros.launch.reload                  | RPC  | `(request: LaunchLoadRequest) => LaunchLoadReply`                         | Reloads launch file by crossbar request                                                  |
| ros.launch.unload                  | RPC  | `(request: LaunchFile) => LaunchLoadReply`                                | Unload a launch file                                                                     |
| ros.launch.get_list                | RPC  | `() => List[LaunchContent]`                                               |                                                                                          |
...
| ros.launch.get_included_files      | RPC  | `(request: LaunchIncludedFilesRequest) => List[LaunchIncludedFile]`       | Returns all included files in given launch file.                                         |
| ros.launch.interpret_path          | RPC  | `(request: LaunchInterpretPathRequest) => List[LaunchInterpretPathReply]` | Returns for given text all detected include paths.                                       |
...
| ros.system.get_uri                 | RPC  | `() => str`                                                               | Format ROS_MASTER_URI [CROSSBAR PORT]                                                    |
| ros.parameters.get_list            | RPC  | `() => List[RosParameter]`                                                | Return all parameters as list (including values and types)                               |
| ros.parameters.get_node_parameters | RPC  | `(nodes: List[str]) => List[RosParameter]`                                | Return a parameter list for a given Node                                                 |
...
| ros.parameters.delete_parameters   | RPC  | `(parameters: List[str]) => bool`                                         | Delete a list of parameters                                                              |
