...
| ros.nodes.get_list                 | RPC  | `() => RosNode[]`                                                        | see fkie_mas_pylib/crossbar/runtime_interface/RosNode                                    |
...
| ros.provider.get_warnings          | RPC  | `() => SystemWarningGroup[]`                                             | see fkie_mas_pylib/crossbar/file_interface/RosPackage                                    |
| ros.packages.get_list              | RPC  | `(clear_cache: bool) => RosPackage[]`                                    | see fkie_mas_pylib/crossbar/file_interface/RosPackage                                    |
| ros.path.get_list                  | RPC  | `(inputPath: str) => PathItem[]`                                         | see fkie_mas_pylib/crossbar/file_interface/PathItem                                      |
