...
const URI = {
  ...
  ROS_TOPICS_GET_LIST: "ros.topics.get_list",
  ROS_TOPICS_CHANGED: "ros.topics.changed",
  ROS_SERVICES_GET_LIST: "ros.services.get_list",
  ROS_SERVICES_CHANGED: "ros.services.changed",
  ...
  ROS_LAUNCH_ROS_RUN: "ros.launch.ros_run",
