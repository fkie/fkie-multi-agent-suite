...
const ZENOH_CONFIG_OVERRIDE='listen/endpoints=["tcp/0.0.0.0:0"];routing/peer/mode="linkstate";scouting/multicast/enabled=true;scouting/multicast/address="224.0.0.224:7452";scouting/multicast/listen=true'
...
export const SETTINGS_DEF: { [id: string]: ISettingsParam } = {
  ...
  zenohConfigOverride: {
    label: "ZENOH_CONFIG_OVERRIDE",
    type: "string",
    freeSolo: true,
    default: ZENOH_CONFIG_OVERRIDE,
    options: [ZENOH_CONFIG_OVERRIDE],
    description: "",
  },
  editorOpenLocation: {
