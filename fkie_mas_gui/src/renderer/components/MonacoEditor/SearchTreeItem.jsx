...
const SearchFileTreeItem = React.forwardRef(function SearchFileTreeItem(
  { labelIcon = null, labelText = "", labelInfo = "", labelCount = 0, ...other },
  ref
) {
  return (
    <SearchTreeItemRoot
      label={
        <Stack direction="column">
          <Stack spacing={1} direction="row" alignItems="center" marginLeft={1}>
            ...
            <Typography flexGrow={1} variant="body2" sx={{ fontWeight: "inherit" }}>
              {labelText}
            </Typography>
...
const SearchResultTreeItem = React.forwardRef(function SearchResultTreeItem(
  { labelIcon = null, labelText = "", labelInfo = "", onClick = null, ...other },
  ref
) {
  return (
    <SearchTreeItemRoot
