...
from fkie_mas_pylib.defines import PRIV_NAME, SEP


def ns_join(ns: str, name: str) -> str:
    """
...
def namespace(
    name: str, with_sep_suffix: bool = True, global_on_none: bool = False, raise_err_on_none: bool = True
) -> str:
    """
